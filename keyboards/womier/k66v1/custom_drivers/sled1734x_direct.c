...
const uint8_t PROGMEM led_map[SLED1734X_LED_COUNT][4] = {
    ...
    { 0x24, 0x34, 0x44, PAGE_FRAME_1},      //2
    { 0x23, 0x33, 0x43, PAGE_FRAME_1},      //3
    { 0x5F, 0x6F, 0x7F, PAGE_FRAME_1},      //4
    { 0x5E, 0x6E, 0x7E, PAGE_FRAME_1},      //5
    { 0x5D, 0x6D, 0x7D, PAGE_FRAME_1},      //6
    { 0x5C, 0x6C, 0x7C, PAGE_FRAME_1},      //7
    { 0x5B, 0x6B, 0x7B, PAGE_FRAME_1},      //8
    { 0x5A, 0x6A, 0x7A, PAGE_FRAME_1},      //9
    { 0x59, 0x69, 0x79, PAGE_FRAME_1},      //10
    { 0x58, 0x68, 0x78, PAGE_FRAME_1},      //11
    { 0x57, 0x67, 0x77, PAGE_FRAME_1},      //12
    { 0x56, 0x66, 0x76, PAGE_FRAME_1},      //13
    { 0x52, 0x62, 0x72, PAGE_FRAME_1},      //14
    { 0x51, 0x61, 0x71, PAGE_FRAME_1},      //15
    { 0x50, 0x60, 0x70, PAGE_FRAME_1},      //16
    { 0x2F, 0x3F, 0x4F, PAGE_FRAME_1},      //34
    { 0x2E, 0x3E, 0x4E, PAGE_FRAME_1},      //35
    { 0x2D, 0x3D, 0x4D, PAGE_FRAME_1},      //36
    { 0x2C, 0x3C, 0x4C, PAGE_FRAME_1},      //37
    { 0x2B, 0x3B, 0x4B, PAGE_FRAME_1},      //38
    { 0x2A, 0x3A, 0x4A, PAGE_FRAME_1},      //39
    { 0x29, 0x39, 0x49, PAGE_FRAME_1},      //40
    { 0x28, 0x38, 0x48, PAGE_FRAME_1},      //41
    { 0x27, 0x37, 0x47, PAGE_FRAME_1},      //42
    { 0x26, 0x36, 0x46, PAGE_FRAME_1}       //43
    { 0x8F, 0x9F, 0x2F, PAGE_FRAME_SPLIT},  //17
    { 0x8E, 0x9E, 0x2E, PAGE_FRAME_SPLIT},  //18
    { 0x8D, 0x9D, 0x2D, PAGE_FRAME_SPLIT},  //19
    { 0x8C, 0x9C, 0x2C, PAGE_FRAME_SPLIT},  //20
    { 0x8B, 0x9B, 0x2B, PAGE_FRAME_SPLIT},  //21
    { 0x8A, 0x9A, 0x2A, PAGE_FRAME_SPLIT},  //22
    { 0x89, 0x99, 0x29, PAGE_FRAME_SPLIT},  //23
    { 0x85, 0x95, 0x25, PAGE_FRAME_SPLIT},  //24
    { 0x84, 0x94, 0x24, PAGE_FRAME_SPLIT},  //25
    { 0x83, 0x93, 0x23, PAGE_FRAME_SPLIT},  //26
    { 0x82, 0x92, 0x22, PAGE_FRAME_SPLIT},  //27
    { 0x81, 0x91, 0x21, PAGE_FRAME_SPLIT},  //28
    { 0x80, 0x90, 0x20, PAGE_FRAME_SPLIT},  //29
    { 0x38 + SLED1734X_FRAME_OFFSET, 0x48, 0x58, PAGE_FRAME_2}, //30
    { 0x3E + SLED1734X_FRAME_OFFSET, 0x4E, 0x5E, PAGE_FRAME_2}, //31
    { 0x3D + SLED1734X_FRAME_OFFSET, 0x4D, 0x5D, PAGE_FRAME_2}, //32
    { 0x3C + SLED1734X_FRAME_OFFSET, 0x4C, 0x5C, PAGE_FRAME_2}, //33
